...
// console.log(arrayDiferentesTiposDeDatos[1])
// console.table(arrayDiferentesTiposDeDatos)
// console.log(arrayDiferentesTiposDeDatos.length)
// console.log(arrayDiferentesTiposDeDatos.toString(':mone'))
...
// const nuevoArreglo = [...tecnologias, 'GraphQL'] // Añade todos los elementos de "tecnologias" al comienzo de nuevoArreglo
// const nuevoArreglo = ['GraphQL', ...tecnologias] // Añade todos los elementos de "tecnologias" al final de nuevoArreglo
...
// Obtener un nuevo array con todos los elementos que cumplan la condición
 const nuevoArray = tecnologias.filter(tecnologia =>  tecnologia === 'React' || tecnologia === 'HTML')
...
// ForEach - Sólo se debe usar cuando no aplico ningun cambio de estado sobre los elementos que recorro (porque muta al array)
// tecnologias.forEach(tecnologia => console.log(tecnologia))


// Crear un nuevo array 
const tecnologiasBis = tecnologias.map(tecnologia => tecnologia + "_bis")

const tecnologiasMayorA4Char = tecnologias.filter(tecnologia => tecnologia.length > 4)

// console.log(tecnologiasBis)
